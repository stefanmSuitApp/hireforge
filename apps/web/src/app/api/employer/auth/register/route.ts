...
import { clearNonEmployerSessionCookies } from '@/lib/auth-cookie-utils';
import {
...
export async function POST(req: Request) {
  ...
  const url = nestApiUrl(origin ?? '', 'auth/employer/register');
  if (!url) {
  ...
  clearNonEmployerSessionCookies(cookieStore);
